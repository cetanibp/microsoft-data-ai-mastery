...
Next: local keyword retrieval over both chunk sets using development questions only. Approval, fixture implementation, keyword/vector/hybrid comparisons, two chunking strategies, live permission/revocation evidence, model answers, performance, ADR-009 and deployment handoff remain open.
